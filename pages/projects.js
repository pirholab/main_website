...
const ProjectsPage = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            demoLink:
                "https://play.google.com/store/apps/details?id=com.pirhotech.pirhoscanner",
            category: "Mobile App",
            status: "Live",
            year: 2024,
            duration: "2.5 months",
        ...
        {
            id: 8,
            title: "McLaren P1 - Ultimate Hybrid Hypercar",
            description:
                "Explore the McLaren P1, the ultimate hybrid hypercar with cutting-edge technology and performance.",
            image: "./web.png",
            video: null,
            tags: [
                "Car",
            ...
            link: null,
            demoLink: "https://mclearn-p1-3d-car-website.vercel.app/",
            category: "Web App",
            status: "Beta",
            year: 2024,
            duration: "1 months",
            ...
            industry: "Automobile",
            challenge:
                "Showcasing the McLaren P1's advanced hybrid technology and performance",
            results: null,
        },

        {
            id: 9,
            title: "SkillStreet - GAME-POWERED | Educational Platform",
            description:
                "SkillStreet is an innovative educational platform that combines gaming and learning to provide a unique and engaging experience for students.",
            image: "./skill_street/mockup.jpeg",
            video: null,
            tags: ["Analytics", "Learning", "Education", "EdTech"],
            link: null,
            demoLink: "https://skill-street.onrender.com/",
            category: "Web App",
            status: "Beta",
            year: 2025,
            duration: "2 months",
            ...
            client: null,
            industry: "Education",
            challenge: "Enhancing student engagement through gamified learning",
            results: null,
        },
    ];
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        {project.demoLink && (
                            <a
                                ...
                                target="_blank"
                                className="flex-1 px-4 py-3 bg-gray-800/60 hover:bg-gray-700 text-gray-300 hover:text-white text-sm font-semibold rounded-xl border border-gray-700/50 hover:border-orange-500/50 transition-all duration-300 hover:shadow-lg flex items-center justify-center gap-2 hover:-translate-y-0.5"
                            >
                                Live Demo
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6">
                        ...
                        <div className="text-center mb-10">
                            ...
                            <p className="text-base sm:text-lg text-gray-400 leading-relaxed max-w-2xl mx-auto">
                                Explore our comprehensive collection of mobile &
                                web applications—each designed for real-world
                                impact, built with cutting-edge technology.
                            </p>
                        </div>
                            ...
                            filteredProjects.length > 6 && (
                                <div className="text-center space-y-4">
                                    ...
                                    <p className="text-gray-500 text-sm">
                                        You've seen all available projects in
                                        this category
                                    </p>
                                </div>
                            )}
                        ...
                        <div className="relative bg-gradient-to-r from-purple-900/30 to-orange-900/30 backdrop-blur-xl rounded-3xl border border-gray-800/50 overflow-hidden">
                            ...
                            <div className="relative p-12 text-center">
                                ...
                                <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                                    ...
                                    life with cutting-edge technology and
                                    exceptional design.
                                </p>
