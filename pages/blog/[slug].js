...
const BlogPost = () => {
    ...
    const processContent = (content) => {
        ...
        codeBlocks.forEach((codeBlock) => {
            ...
            const placeholder = `<div class="syntax-highlight" data-code="${encodeURIComponent(
                code
    ...
    const RenderContent = ({ content }) => {
        ...
        const parts = processedContent.split(
            /<div class="syntax-highlight" data-code="([^"]*)" data-language="([^"]*)">\s*<\/div>/
        );
    ...
    return (
        <>
            <Head>
                <title>{blog.title} - PirhoTech</title>
