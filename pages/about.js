            ...
            >
                <div className="w-[90%] sm:w-[83%]">
                            ...
                            >
                                ...
                                <div className="absolute w-full bottom-0 flex flex-col items-start">
                                    ...
                                    <div className="bottom-0 flex items-end">
                                        <div className="p-[15px] pl-[30px] bg-[#03061c] rounded-tr-[30px]">
                                            <h1 className="text-xl">
                                                {e.name}
                                            </h1>
                                            <p className="font-[100] opacity-[0.5]">
                                                {e.skill}
                                            </p>
                                        </div>
                                        <svg
                    ...
                    <p className="text-xl font-[100] opacity-[0.7]">
                        At PiRhoTech, we truly care about your work and the
                        impact it has. Our team is committed to delivering
                        high-quality results with creativity and precision. We
                        work closely with you to understand your goals and
                        ensure every detail aligns with your vision. With our
                        expertise and dedication, we help bring your ideas to
                        life in the best possible way. Together, we can achieve
                        exceptional outcomes and make your project stand out.
                    </p>
