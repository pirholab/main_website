...
const NAVIGATION_ITEMS = [
    ...
    { href: "/blogs", label: "Blog", useTransition: true },
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            {NAVIGATION_ITEMS.map((item) =>
                                renderNavItem(
                                    item,
                                    "text-white/80 hover:text-white font-medium px-4 py-2 rounded-lg hover:bg-white/5 transition-all duration-300"
                                )
                            )}
                        </div>
                    ...
                    >
                        ...
                        >
                            {NAVIGATION_ITEMS.map((item) =>
                                renderNavItem(
                                    item,
                                    "block text-white/90 hover:text-white text-2xl font-medium py-3 hover:bg-white/5 rounded-lg px-4 transition-all duration-300",
                                    true
                                )
                            )}
