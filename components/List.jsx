            ...
            <div>
                <HeroHighlight>
                    <motion.h1
                        ...
                        className="text-2xl px-4 md:text-4xl lg:text-5xl text-white max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto relative top-[13dvh]"
                    >
                        We craft custom websites, focusing on{" "}
                        <Highlight className="text-white">three key</Highlight>{" "}
                        elements.
                    </motion.h1>
                </HeroHighlight>
                <br />
